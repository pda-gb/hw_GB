...
while i < len_list1:
    var_list1.append(random.randint(-10, 10))
    i += 1
print('Дано', var_list1)

for itm in var_list1:
    if itm > 0 and math.sqrt(abs(itm)) % 1 == 0:
         var_list2.append(math.sqrt(itm))
print(var_list2)
...
print(dict_d[str_d] +' ' + dict_m[str_m] +' ' + str_y + ' года')
...
i = 0
while i < len_list1:
    var_list1.append(random.randint(-100, 100))
    i += 1
print(var_list1)
